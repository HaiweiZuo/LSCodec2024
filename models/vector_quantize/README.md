...
```python
import torch
from vector_quantize import GroupedResidualVQ
...
```python
import torch
from vector_quantize import RandomProjectionQuantizer
...
```python
import torch
from vector_quantize import FSQ
...
```python
import torch
from vector_quantize import ResidualFSQ
...
```python
import torch
from vector_quantize import LFQ
...
```python
import torch
from vector_quantize import ResidualLFQ
...
```python
import torch
from vector_quantize import LatentQuantize
